...
angular.module('ututorials', [])

.service('Ututorials', [function(){
    ...
    var ututorials_list = [
      ...
      for (var i=0;i<ututorials_list.length;i++){
        ututorials_keys[ututorials_list[i].key] = ututorials_list[i];
      }

    return {
        list: ututorials_list,
        keys: ututorials_keys
    }
